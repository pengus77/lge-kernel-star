...
static struct dvfs dvfs_init[] = {
	...
	CORE_DVFS("epp",     -1, 1, KHZ, 133000, 171000, 247000, 333500, 333500, 350000, 350000, 350000, 350000, 350000),
	CORE_DVFS("2d",      -1, 1, KHZ, 133000, 171000, 247000, 333500, 333500, 350000, 350000, 350000, 350000, 350000),
	CORE_DVFS("3d",      -1, 1, KHZ, 161500, 209000, 285000, 333500, 333500, 350000, 350000, 380000, 380000, 380000),
	CORE_DVFS("mpe",     -1, 1, KHZ, 142500, 190000, 275500, 333500, 333500, 350000, 350000, 350000, 350000, 350000),
	CORE_DVFS("vi",      -1, 1, KHZ, 85000,  100000, 150000, 150000, 150000, 150000, 150000, 150000, 150000, 150000),
	CORE_DVFS("sclk",    -1, 1, KHZ, 123500, 159500, 207000, 240000, 240000, 264000, 300000, 300000, 350000, 350000),
	CORE_DVFS("vde",     -1, 1, KHZ, 123500, 152000, 237500, 333500, 333500, 350000, 350000, 350000, 350000, 350000),
