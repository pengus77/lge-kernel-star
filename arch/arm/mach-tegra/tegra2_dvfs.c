...
static struct dvfs dvfs_init[] = {
...
#else
	CORE_DVFS("emc",     -1, 2, KHZ, 57000,  333000, 380000, 666000, 666000, 666000, 760000, 760000, 760000, 760000),
#endif

	CORE_DVFS("sdmmc1",  -1, 2, KHZ, 44000,  52000,  52000,  52000,  52000,  52000,  52000,  52000,  52000,  52000),
	CORE_DVFS("sdmmc2",  -1, 2, KHZ, 44000,  52000,  52000,  52000,  52000,  52000,  52000,  52000,  52000,  52000),
	CORE_DVFS("sdmmc3",  -1, 2, KHZ, 44000,  52000,  52000,  52000,  52000,  52000,  52000,  52000,  52000,  52000),
	CORE_DVFS("sdmmc4",  -1, 2, KHZ, 44000,  52000,  52000,  52000,  52000,  52000,  52000,  52000,  52000,  52000),

	CORE_DVFS("ndflash", -1, 2, KHZ, 130000, 150000, 158000, 164000, 164000, 164000, 164000, 164000, 164000, 164000),
	CORE_DVFS("nor",     -1, 2, KHZ, 0,      92000,   92000,  92000,  92000,  92000,  92000,  92000,  92000,  92000),
	CORE_DVFS("ide",     -1, 2, KHZ, 0,      0,      100000, 100000, 100000, 100000, 100000, 100000, 100000, 100000),
	CORE_DVFS("mipi",    -1, 2, KHZ, 0,      40000,   40000,  40000,  40000,  60000,  60000,  60000,  60000,  60000),
	CORE_DVFS("usbd",    -1, 2, KHZ, 0,      0,      480000, 480000, 480000, 480000, 480000, 480000, 480000, 480000),
	CORE_DVFS("usb2",    -1, 2, KHZ, 0,      0,      480000, 480000, 480000, 480000, 480000, 480000, 480000, 480000),
	CORE_DVFS("usb3",    -1, 2, KHZ, 0,      0,      480000, 480000, 480000, 480000, 480000, 480000, 480000, 480000),
	CORE_DVFS("pcie",    -1, 2, KHZ, 0,      0,      0,      250000, 250000, 250000, 250000, 250000, 250000, 250000),
	CORE_DVFS("dsia",    -1, 2, KHZ, 100000, 100000, 100000, 500000, 500000, 500000, 500000, 500000, 500000, 500000),
	CORE_DVFS("tvo",     -1, 2, KHZ, 0,      0,      0,      250000, 250000, 250000, 250000, 250000, 250000, 250000),
	...
	CORE_DVFS("host1x",  -1, 2, KHZ, 104500, 133000, 166000, 166000, 166000, 166000, 166000, 166000, 166000, 166000),
	CORE_DVFS("epp",     -1, 2, KHZ, 133000, 171000, 247000, 333500, 333500, 350000, 350000, 350000, 350000, 350000),
	CORE_DVFS("2d",      -1, 2, KHZ, 133000, 171000, 247000, 333500, 333500, 350000, 350000, 350000, 350000, 350000),
	CORE_DVFS("3d",       1, 2, KHZ, 161500, 209000, 285000, 333500, 333500, 400000, 400000, 400000, 400000, 400000),
	CORE_DVFS("mpe",      1, 2, KHZ, 142500, 190000, 275500, 333500, 333500, 350000, 350000, 350000, 350000, 350000),
	CORE_DVFS("vi",      -1, 2, KHZ, 85000,  100000, 150000, 150000, 150000, 150000, 150000, 150000, 150000, 150000),
	CORE_DVFS("sclk",     1, 2, KHZ, 123500, 159500, 207000, 240000, 240000, 264000, 300000, 300000, 350000, 350000),
	CORE_DVFS("vde",      1, 2, KHZ, 123500, 152000, 237500, 333500, 333500, 350000, 350000, 350000, 350000, 350000),
	/* What is this? */
	CORE_DVFS("NVRM_DEVID_CLK_SRC", -1, 2, MHZ, 480, 600, 800, 1067, 1067, 1067, 1067, 1067, 1067, 1067),
};
#else
static struct dvfs dvfs_init[] = {
